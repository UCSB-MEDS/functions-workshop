...
::: {.callout-note}
I'll be writing the following code in a script called, `no_functions.R`, which I'll save to my repo's root directory.
:::
...
You can then **source** your functions into whatever script (or rmd/qmd file) where you call that function (e.g. `source("utils/do_fun_thing.R")`. 
...
-  a `using_functions.R` file (saved to the root directory), where we'll use our functions to clean and plot our data
:::
